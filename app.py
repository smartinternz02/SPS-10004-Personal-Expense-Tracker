...
app.config['MYSQL_USER'] = 's3jotogZcF'
app.config['MYSQL_PASSWORD'] = 'EaPQN1no1l'
app.config['MYSQL_DB'] = 's3jotogZcF'

app.config["MAIL_SERVER"] = 'smtp.gmail.com'
app.config['MAIL_PORT']=465
app.config['MAIL_USERNAME']="dummy3843@gmail.com"
app.config['MAIL_PASSWORD']=  "ABCD3030"
